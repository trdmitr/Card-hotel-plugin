(function () {
        ...
        data.forEach(room => {
            ...
            if (mainImg) {
                ...
                mainImg.onclick = function (e) {
                    e.stopPropagation();
                    openLightbox(room, room.images, 0);
                };
            }
            ...
            thumbs.forEach((thumb, idx) => {
                ...
                thumb.onclick = function (e) {
                    e.stopPropagation();
                    openLightbox(room, room.images, idx + 1);
                };
            });
    ...
    function openLightbox(room, images, startIndex) {
    ...
    fetch(dataUrl)
        ...
        .catch(err => {
            ...
            if (container) container.innerHTML = `<p style="color:red">Ошибка: ${err.message}</p>`;
        });
